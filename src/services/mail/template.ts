  ...
  <body>
    <main style="background-color: #fff; height: 700px; width: 100%; font-family: sans-serif;">
      <div style="height: 100px; width: 100%; background-color: #48e; box-sizing: border-box; padding: 0; margin: 0;">
        ...
        <a style="text-decoration: none; color: #000; border: 2px solid #48e;; border-radius: 10px; padding: 15px; background: transparent; cursor: pointer; font-size: 15px;" href="https://p-final-p-ccorp-front.vercel.app/verify/?token=${token}">verify yourself now</a>
    </main>
  </body>
  </html>
      `;
